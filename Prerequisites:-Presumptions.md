...
The Cloudbox setup is all done on the command line in the linux shell.  There is no GUI and there are no plans to add one.  If you want to run Cloudbox, you *will* need to be familiar with Linux.
